<div class="mobile-menu md:hidden" ng-controller="SidebarController">
    ...
    <div class="scrollable">
        ...
        <ul class="scrollable__content py-2">
            ...
            <li>
                <a href="javascript:;" ng-click="openChangelog()" class="menu">
                    <div class="menu__icon"> <i data-lucide="history"></i> </div>
                    <div class="menu__title"> Changelog <span class="ml-2 text-xs bg-primary/20 text-primary px-2 py-0.5 rounded-full font-semibold">v2.0.0</span></div>
                </a>
            </li>
        </ul>
    </div>
