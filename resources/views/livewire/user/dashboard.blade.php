...
state([
    'apply_count' => \DB::table('applications')->where('user_id', auth()->user()->id)->count(),
    'send_cv' => \DB::table('applications')->where(['user_id' => auth()->user()->id,'status' => 'Send CV'])->count(),
    'viewed' => \DB::table('applications')->where(['user_id' => auth()->user()->id,'status' => 'Viewed'])->count(),
    'interview_hrd' => \DB::table('applications')->where(['user_id' => auth()->user()->id,'status' => 'Interview HRD'])->count(),
    'interview_user' => \DB::table('applications')->where(['user_id' => auth()->user()->id,'status' => 'Interview User'])->count(),
    'failed' => \DB::table('applications')->where(['user_id' => auth()->user()->id,'status' => 'Failed'])->count(),
    'success' => \DB::table('applications')->where(['user_id' => auth()->user()->id,'status' => 'Success'])->count()
]);
